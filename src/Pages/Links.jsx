...
import { addUserLink } from "../firebase/firestore";
...
function Links() {
  ...
  const setData = async (title, url) => {
    await addUserLink(user.username, { title, url });
  };
          ...
          <div className="grid grid-cols-10">
            <div className="col-span-6">
              <section className="p-10 max-w-2xl mx-auto">
                ...
                {linksData.length === 0 && (
                  <div className="absolute top-[50%] left-[24%] -z-50">
