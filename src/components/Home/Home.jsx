        ...
        <div className="fixed top-0 w-full z-50 p-8">
          <div className="bg-white rounded-full flex p-2 flex-row justify-between">
            <ul className="flex flex-row p-2 gap-3 text-xl text-center items-center ps-8">
              ...
              <li className="text-center font-bold cursor-pointer bg-gradient-to-r from-sky-600 via-pink-600 to-sky-600 bg-clip-text text-transparent text-3xl">
                Your LinkTree
              </li>
            </ul>
            <ul className="flex flex-row p-2 gap-5 pe-5 items-center">
              <li className="hover:bg-green-700 hover:text-white bg-slate-100 transition-color rounded-2xl p-3 min-w-32 min-h-14 font-bold cursor-pointer flex flex-row gap-1 text-xl justify-center items-center">
                <IconLogin2 /> Login
              </li>
              <li className=" transition-colors hover:text-white hover:bg-black rounded-xl p-3 min-w-36 min-h-16 font-bold cursor-pointer flex flex-row gap-1 text-xl justify-center items-center bg-slate-300">
                <IconUserPlus /> <Link rel="stylesheet" to="/signup" >SignUp</Link>
              </li>
            </ul>
          </div>
        </div>
